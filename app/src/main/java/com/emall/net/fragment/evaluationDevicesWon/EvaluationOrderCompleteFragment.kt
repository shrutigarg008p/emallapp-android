...
class EvaluationOrderCompleteFragment : Fragment() {

    private lateinit var viewModel: MainViewModel
    private var token: String? = ""
    private var evaluationWonId: Int? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getSellerBankDetailsForEvaluation(evaluationWonId!!, "Bearer $token",Utility.getLanguage())
        ...
        upload_file_receipt_btn.setOnClickListener {
            viewModel.evaluationDeviceWonPayment(evaluationWonId!!, "Bearer $token",
                        ...
                        when (resource.status) {
                            Status.SUCCESS -> {
                                resource.data?.let { it ->
                                    ...
                                    (activity as BuyerActivity).moveToBuyerScreen()

...
import com.emall.net.network.model.dashboard.DataBestDeal
...
class BestDealsAdapter(private val data: ArrayList<DataBestDeal>, val itemClick: OnItemClick) :
    RecyclerView.Adapter<BestDealsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            itemClick.onItemClick(position, "best deals")
        }
    }

...
import com.emall.net.network.model.dashboard.DataTopOffer
...
class TopOffersAdapter(private val data: ArrayList<DataTopOffer>, val itemClick: OnItemClick) :
    RecyclerView.Adapter<TopOffersAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            itemClick.onItemClick(position, "top offers")
        }
    }

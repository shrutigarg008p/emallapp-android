...
class ViewPagerAdapterNew(private var mainBannerList: ArrayList<String>, val itemClick: OnItemClick) :
    PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val view = layoutInflater.inflate(R.layout.view_pager_image_new, null)

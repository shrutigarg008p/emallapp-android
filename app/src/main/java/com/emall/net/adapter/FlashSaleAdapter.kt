...
import com.emall.net.network.model.dashboard.ProductX
...
class FlashSaleAdapter(private val data: ArrayList<ProductX>, val itemClick: OnItemClick) :
    RecyclerView.Adapter<FlashSaleAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            itemClick.onItemClick(position, "flash sale")
        }
    }

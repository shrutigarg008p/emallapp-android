...
import com.emall.net.network.model.dashboard.DataPopularSearch
...
class PopularSearchAdapter(private val data: ArrayList<DataPopularSearch>, val itemClick: OnItemClick) :
    RecyclerView.Adapter<PopularSearchAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            itemClick.onItemClick(position, "popular search")
        }
    }
